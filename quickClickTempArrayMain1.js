...
nounsSingLatinArray = nounsFirstSing[nounsFirstSingIndx][0] + pEFirstSing[pEFirstSingIndx][0];
nounsSingTransArray = pEFirstSing[pEFirstSingIndx][1] + nounsFirstSing[nounsFirstSingIndx][1];

nounsPlLatinArray = nounsFirstPl[nounsFirstPlIndx][0] + pEFirstPl[pEFirstPlIndx][0];
nounsPlTransArray = pEFirstPl[pEFirstPlIndx][1] + nounsFirstPl[nounsFirstPlIndx][1];
